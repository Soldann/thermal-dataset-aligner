...
image_num = 1
rgb_img = f"/home/landson/RGBT-Scenes/Building/rgb/test/img_{image_num:03d}.jpg"
therm_img = f"/home/landson/RGBT-Scenes/Building/thermal/test/img_{image_num:03d}.jpg"


print (f"Image 0 path: {rgb_img}")
print (f"Image 1 path: {therm_img}")
# Load and match images
# Note: images are converted to grayscale before matching
output_data = matcher.from_paths(therm_img, rgb_img, read_color=True)
...
inlier_method = 'T' # F: Fundamental Matrix, H: Homography 
