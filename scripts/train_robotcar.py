...
from models.model_robotcar import CVM
...
for epoch in range(epoch_to_resume, 100):
    ...
    for i, data in enumerate(train_dataloader, 0):
        ...
        infonce_loss = torch.mean(compute_infonce_loss(Rgt, tgt, X, Y, sampled_matching_row, sampled_matching_col, sat_indices_topk.squeeze(1), grd_indices_topk.squeeze(1), sat_keypoint_coord, grd_keypoint_coord, matching_score_original))
        
        avg_loss = distance_loss + beta * infonce_loss
